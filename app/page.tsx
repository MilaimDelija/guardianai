          ...
          {[
            {
              ...
              period: "/month",
              target: "Individuals",
              features: ["1-3 devices protected", "Real-time browser protection", "ChatGPT · Claude · Gemini", "Layer 1 + Layer 2 scanning", "500 scans/month", "Email support"],
              cta: "Get started",
              highlight: false,
            },
            {
              ...
              features: ["Up to 5 AI agents", "REST API + Bearer token", "Layer 1 + Layer 2", "Output filtering", "5,000 scans/month", "Email support"],
              cta: "Get started",
              highlight: false,
            },
            {
              ...
              period: "/month",
              target: "Companies",
              features: ["Up to 20 AI agents", "REST API + Bearer token", "All layers + output filter", "Webhook alerts", "25,000 scans/month", "Dashboard analytics", "Priority support (48h)"],
              cta: "Get started",
              highlight: true,
            },
            {
              ...
              features: ["Unlimited agents + devices", "On-premise deployment", "Custom threat rules", "Unlimited scans", "SLA 99.9%", "Dedicated support"],
              cta: "Contact us",
              highlight: false,
            },
          ].map((plan) => (
